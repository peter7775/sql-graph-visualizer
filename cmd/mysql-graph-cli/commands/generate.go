/*
 * MySQL Graph Visualizer - Generate Command
 *
 * Copyright (c) 2024
...
- minimal: Minimal configuration template`,
  ...
  mysql-graph-cli generate --template all --output-dir ./examples

  # Generate Sakila database example
  mysql-graph-cli generate --template sakila`,
...
func runGenerate(opts generateOptions) error {
	fmt.Println("🔧 MySQL Graph Visualizer - Configuration Generator")
	fmt.Println("==================================================")
...
func generateProductionConfig(outputDir string, force bool) error {
	...
	config := `# MySQL Graph Visualizer - Production Configuration
...
func generateDevelopmentConfig(outputDir string, force bool) error {
	...
	config := `# MySQL Graph Visualizer - Development Configuration
# Issue #10 - Direct Database Connection Implementation
...
func generateTestingConfig(outputDir string, force bool) error {
	...
	config := `# MySQL Graph Visualizer - Testing Configuration
# Issue #10 - Direct Database Connection Implementation
...
func generateSakilaConfig(outputDir string, force bool) error {
	...
	config := `# MySQL Graph Visualizer - Sakila Sample Database Configuration
# Issue #10 - Direct Database Connection Implementation
...
func generateMinimalConfig(outputDir string, force bool) error {
	...
	config := `# MySQL Graph Visualizer - Minimal Configuration Template
# Issue #10 - Direct Database Connection Implementation
...
func generateAllConfigs(outputDir string, force bool) error {
	...
	readme := `# MySQL Graph Visualizer - Configuration Examples
