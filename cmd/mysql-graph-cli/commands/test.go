/*
 * MySQL Graph Visualizer - Test Command
 *
 * Copyright (c) 2024
...
- Server information`,
  ...
  mysql-graph-cli test --host remote-db.com --port 3306 --username user --password pass --database prod --detailed`,
...
func runTest(opts testOptions) error {
	fmt.Println("🧪 MySQL Graph Visualizer - Connection Test")
	fmt.Println("===========================================")
